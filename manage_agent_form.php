                    ...
                    <div  id="porjectDetail">
                        ...
                        <div class="row"> 
                            <div class="card col-8">                             
                                <div class="card-body">
                                    <form class="form" action="_op_main.php?op=<?= isset($list) ? '&id=' . $_GET['id'] : '' ?>" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <input type="number" class="form-control" name="QueueNumber" value="<?= isset($list) ? $list['DIDNumber'] : '' ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Agent Number * </label>
                                            <div>
                                                <input type="number" class="form-control" name="AgentNumber" value="<?= isset($list) ? $list['QueueNumber'] : '' ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>Description </label>
                                            <div>
                                                <textarea  class="form-control"   rows="5" name="ADescription"><?= isset($list) ? $list['DidDescription'] : '' ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
