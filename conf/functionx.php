...
class functionx extends Crud {
    ...
    public function getCallBack() {
        ...
        if (isset($_GET['date']) && !empty($_GET['date'])) {
            ...
            $enddate = trim($date[5] + 543) . '-' . $date[4] . '-' . $date[3];
            $d = array(
        ...
        $where .= " WHERE convert(datetime, DateLeave) BETWEEN '$stardate' AND '$enddate' ";
...
///////////////////// LeaveNum
        ...
        $sql = "SELECT  convert(date, DateLeave) as DateLeave , TimeLeave, CallNum,LeaveNum,FromQueue FROM CallBack $where";
