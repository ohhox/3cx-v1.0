...
class Crud extends DB {
    ...
    public function one_query($table, $where) {
    ...
    public function __setMultiple($array) {
    ...
    public function savewhere($id, $id2) {
        $this->variables[$this->pk] = (empty($this->variables[$this->pk])) ? $id : $this->variables[$this->pk];
        ...
        if (count($columns) > 1) {
            ...
            $sql = "UPDATE " . $this->table . " SET " . $fieldsvals . " WHERE " . $id['name'] . "= :" . $id['name'] . ' AND ' . $id2['name'] . "= :" . $id2['name'];
            if ($id === "0" && $this->variables[$this->pk] === "0") {
                unset($this->variables[$this->pk]);
                $sql = "UPDATE " . $this->table . " SET " . $fieldsvals;
            }
    ...
    public function queryX($sql, $array = null) {
